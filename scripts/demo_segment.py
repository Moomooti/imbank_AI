...
from app.segment import segment_words, split_myanmar_sentences  # noqa: E402
from app.segment.myanmar import CLAUSE_SEP, SENTENCE_END  # noqa: E402
...
def main():
    ...
    # 2) 숫자 뒤 오탐 방지: "၁။ ... ၂။ ..." 같은 번호매김은 문장 경계로 보지 않음
    ...
    # 3) 일반 숫자로 끝나는 진짜 문장은 정상적으로 경계로 인정되어야 함
    #    (번호매김 오탐 방지 규칙이 너무 넓어서 진짜 문장까지 삼키면 안 됨)
