...
from app.mt.finholly_translate import SUPPORTED_LANGS, translate_all  # noqa: E402
from app.mt.ctranslate2_provider import get_finholly_provider  # noqa: E402
...
if __name__ == "__main__":
    ...
    get_finholly_provider()  # 서버 시작 시 미리 로드 (첫 요청 지연 방지)
